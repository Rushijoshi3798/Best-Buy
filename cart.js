...
function displaydata(data){
    ...
    document.querySelector("#totalvalue").innerText = "$" + totalcartvalue.toFixed(2);

    let estimatedTax = totalcartvalue*0.05;

    document.querySelector("#tax").innerText = "$" + estimatedTax.toFixed(2);

    document.querySelector("#mrp").innerText = "$" + +(totalcartvalue+estimatedTax).toFixed(2);

   let discountprice = (totalcartvalue+estimatedTax) * 0.1

    document.querySelector("#discount").innerText = "$" + discountprice.toFixed(2);

    let finalprice = (totalcartvalue+estimatedTax) - discountprice

    document.querySelector("#finalvalueOfcart").innerText = "$" + finalprice.toFixed(2);
